...
**Product identity (20 Aug 2026):** `MASTER_DIRECTION.md` §0 wins. Assistants in use: **Ver** (FOS), **Lens** (Dipstify Station), **Vera** (ODO). Kath in the tables below is the July 18 KOS-agent name — same seat as Lens for Dipstify Station work. Do not invent a fourth assistant.
